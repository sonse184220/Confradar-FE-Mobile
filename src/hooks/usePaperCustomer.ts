import { useLazyGetPaperDetailCustomerQuery, useLazyListAvailableCustomersQuery, useLeaveWaitListMutation, useListAvailableCustomersQuery, useListCustomerWaitListQuery, useListPaperPhasesQuery, useListSubmittedPapersForCustomerQuery, useSubmitAbstractMutation, useSubmitCameraReadyMutation, useSubmitFullPaperMutation, useSubmitPaperRevisionMutation, useSubmitPaperRevisionResponseMutation } from "@/store/api/paperApi";
import { ApiResponse } from "@/types/api.type";
import { AvailableCustomerResponse, CreateAbstractRequest, CreateCameraReadyRequest, CreateFullPaperRequest, CreateRevisionPaperSubmissionRequest, CreateRevisionPaperSubmissionResponse, PaperDetailResponse } from "@/types/paper.type";
